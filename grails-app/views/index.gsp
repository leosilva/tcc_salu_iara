							...
							<div class="panel-body">
								<table class="table bootstrap-datatable countries">
									...
									<tbody>
										<tr>
											<td>
												<asset:image src="Germany.png" style="height: 18px; margin-top: -2px;"/>
											</td>
											<td>Germany</td>
											<td>2563</td>
											<td>1025</td>
										...
										<tr>
											<td><asset:image src="India.png" style="height: 18px; margin-top: -2px;" /></td>
											<td>India</td>
											<td>3652</td>
											<td>2563</td>
											<td>
										...
										<tr>
											<td><asset:image src="Spain.png" style="height: 18px; margin-top: -2px;"/></td>
											<td>Spain</td>
											<td>562</td>
											<td>452</td>
											<td>
								...
								<div class="row">
									...
									<div class="col-lg-4">
										<span class="profile-ava pull-right">
											<asset:image src="avatar1_small.jpg" class="simple"/> Jenifer Smith
										</span>
									</div>
								</div>
							</div>
								...
								<tbody>
									<tr>
										...
										<td><span class="profile-ava"> 
											<asset:image src="avatar1_small.jpg" class="simple"/>
										</span></td>
									</tr>
									<tr>
										<td>Yesterday</td>
